...
class CrearPedidoAction {
    public function __construct(private readonly PedidoService $service, private RegistrarAuditoriaService $auditoriaService) {}
    public function execute(array $data, ?int $codUsuario): Pedido {
        ...
        return DB::transaction(function () use ($data, $codUsuario, $totales) {
            ...
            $this->auditoriaService->registrarInsercion($contexto, 'Pedidos', 'pedidos', (string) $pedido->cod_pedido, submodulo: 'Creación');
