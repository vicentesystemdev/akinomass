...
class RegistrarSalidaInventarioAction
{
    ...
    {
        return $this->service->registrarMovimiento($data['cod_producto'], TipoMovimientoInventarioEnum::SALIDA, $data['cantidad_mov'], $data['motivo_mov'], $data['observacion_mov'] ?? null, $codUsuario);
    }
}
