...
class RegistrarAjusteInventarioAction
{
    ...
    {
        return $this->service->registrarMovimiento($data['cod_producto'], TipoMovimientoInventarioEnum::AJUSTE, 0, $data['motivo_mov'], $data['observacion_mov'] ?? null, $codUsuario, $data['stock_nuevo_mov']);
    }
}
