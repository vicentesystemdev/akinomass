...
export default function Edit({ categoria }) {
    ...
    const submit = () => {
        form.put(route('categorias-producto.update', categoria.cod_categoria_producto));
    };
        ...
        <AuthenticatedLayout
            header={
                <PageHeader
                    ...
                    subtitle={`Modifique los datos de "${categoria.nombre_cat}"`}
                    breadcrumbs={[
        ...
        >
            ...
            <div className="max-w-2xl mx-auto">
                <FormCard
                    ...
                    subtitle="Modifique la información de la categoría"
