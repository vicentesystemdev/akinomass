...
export default function Create({ tipos }) {
    ...
    const submit = () => {
        form.post(route('plantillas-mensaje.store'));
    };
        ...
        <AuthenticatedLayout
            header={
                <PageHeader
                    ...
                    subtitle="Crea un texto sugerido para usar en interacciones"
                    breadcrumbs={[
        ...
        >
            ...
            <div className="max-w-3xl mx-auto">
                <FormCard
                    ...
                    subtitle="Complete la información de la plantilla de mensaje"
                    ...
                    <FormCard.Section title="Contenido del Mensaje">
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Escribe aquí el texto sugerido que el operador podrá copiar y usar..."
                                required
                            />
