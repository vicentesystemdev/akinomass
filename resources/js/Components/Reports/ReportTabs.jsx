...
export default function ReportTabs({ activeTab, onChange }) {
    return (
        <div className="rounded-2xl border border-gray-100 bg-white p-1.5 shadow-sm">
            <nav className="flex gap-1 overflow-x-auto scrollbar-thin" aria-label="Módulos de reporte">
                {tabs.map((tab) => {
                    ...
                    return (
                        <button
                            ...
                            className={`flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold whitespace-nowrap transition-all duration-200 ${
                                isActive
                                    ? 'bg-gradient-to-r from-terracota-500 to-terracota-600 text-white shadow-md shadow-terracota-500/25'
                                    : 'text-gray-500 hover:bg-gray-50 hover:text-cafe-800'
                            }`}
                        >
