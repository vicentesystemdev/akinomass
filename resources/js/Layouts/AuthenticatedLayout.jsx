        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    routeName: 'ventas-redes.index',
                    icon: (
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-4 4-3-4z" />
                        </svg>
                    ),
                ...
                {
                    label: 'Config. tienda',
                    routeName: 'configuracion.tienda.index',
                    icon: (
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    ),
                    canView: hasPermission('configuracion_tienda.ver'),
                },
            ],
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    canView: hasPermission('auditoria.ver'),
                },
            ],
        },
        {
            ...
            items: [
                {
                    ...
                    canView: hasPermission('backups.ver'),
                },
            ],
        },
    ], [permissions]);
